...
class AamarpayController extends Controller
{
    ...
    public function pay(Request $request)
    {
        ...
        $currency = !empty(env('CURRENCY')) ? env('CURRENCY') : 'BDT';
                            ...
                            if ($assignPlan['is_success'] == true && !empty($plan)) {
                                ...
                                Order::create(
                                    [
                                        ...
                                        'price_currency' => !empty(env('CURRENCY')) ? env('CURRENCY') : 'BDT',
                                        'txn_id' => '',
    ...
    public function aamarpaysuccess($data, Request $request)
    {
        ...
        if ($data['response'] == "success")
        {
            ...
            $order->price_currency = !empty(env('CURRENCY')) ? env('CURRENCY') : 'BDT';
