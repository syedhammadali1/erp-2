        ...
        if ($plan) {
            ...
            try {
                            ...
                            if ($assignPlan['is_success'] == true && !empty($plan)) {
                                ...
                                Order::create(
                                    [
                                        ...
                                        'price_currency' => !empty(env('CURRENCY')) ? env('CURRENCY') : 'BHD',
                                        'txn_id' => '',
                ...
                $userData =
                    [
                        "amount" => $get_amount,
                        "currency" =>  !empty(env('CURRENCY')) ? env('CURRENCY') : 'BHD',
    ...
    public function call_back(Request $request)
    {
        ...
        try {
            ...
            if ($status_code == '00') {
                ...
                $order->price_currency =  !empty(env('CURRENCY')) ? env('CURRENCY') : 'BHD';
